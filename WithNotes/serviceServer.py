...
def service(username, service_id, encrypted_user_authenticator_msg, encrypted_ST):
    ...
    try:
        ...
        # [SERVICE] ST contents: {'client_name': 'bob', 'service_id': '3', 'client_ip': '192.168.1.20', 'st_session_key': 'aoWJuw5W3RtwNOjvXyfzfX-d-6V5PXABFK_BKBdDdHM='}
...
# === End of Client Message #1 (Encrypted Service Ticket). Message is Sent From Client -> Service ===
...
# === End of Client Message #2 (Encrypted Message). Message is Sent From Client -> Service ===
